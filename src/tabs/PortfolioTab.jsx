...
// ─── 11. PORTFOLIO TAB ────────────────────────────────────────────────────────
export function PortfolioTab({pools, volData, walletPools = [], walletLoading = false, onFetchWalletPools, onFetchWalletPoolTx, onFetchWalletAssets, onSuggestRebuild, fetchExternal, prices}) {
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:"14px"}}>
      <Card>
        ...
        {selectedWalletPool && (
          // PoolAnalysisPanel receives the pool object as-is.
          // App.jsx already computed:
          //   entryPrice = stableAmt / ethAmt  (price of ETH when LP was opened)
          //   valueUSD   = ethAmt × currentEthPrice + stableAmt
          //   matchedPool = strict chain-aware match (not fuzzy)
          // We do NOT re-derive anything here — just pass through.
          <div style={{marginTop:"10px"}}>
            <PoolAnalysisPanel
              key={selectedWalletPool.id}
              pool={{
                ...selectedWalletPool,
                // entryPrice and valueUSD already set correctly by App.jsx
