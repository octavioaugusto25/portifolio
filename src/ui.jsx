...
import { AUDIT_PROXY, PROTOCOL_COIN_MAP, SAFE_PROTOCOLS, MEDIUM_PROTOCOLS, VOLATILITY_COIN_MAP } from "./constants";
import { calcChainConcentration, calcDiversificationScore, calcIL, calcPortfolioScore, calcRiskConcentration, extractTokens, fmt, fmtK, getFdvRating, getLiqLabel, getMarketContext, getPair, getRisk, getStrategy, getVolLabel, isPairSS, isPairSV, isStable, suggestLPRange } from "./utils";
...
// ─── 11. PORTFOLIO TAB ────────────────────────────────────────────────────────
export function PortfolioTab({pools, prices, volData}) {
...
// ─── AI ADVISOR ───────────────────────────────────────────────────────────────
export function AIAdvisorTab({pools, prices, initialPool}) {
